# install python if u havent already
# download python here: https://www.python.org/
# make sure to open the roblox catalog and filter by collectibles 
...
print("RbxAutoBuy will now buy any limited under 100 robux")
